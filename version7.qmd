...
This comprehensive data science project aimed at identifying, analyzing, and predicting customer attrition within a consumer credit card division. Leveraging a dataset of over 10,000 historic records, the project moves beyond basic reporting to provide actionable risk intelligence.

The dataset consists of anonymized customer data for current and former credit card customers, and includes both demographic data (gender, age, marital status, income, education) and account data (credit limit, revolving balance, transaction information, communication with bank information, etc.). Customer churn (former bank customers) accounts for about 16% of the dataset. 
...
* Tactical Action: Create a prioritized outreach list of at-risk active customers.
